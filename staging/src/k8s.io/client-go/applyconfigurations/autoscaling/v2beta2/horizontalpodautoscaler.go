...
func (b *HorizontalPodAutoscalerApplyConfiguration) WithUsingReferences(values ...*v1.UsingReferenceApplyConfiguration) *HorizontalPodAutoscalerApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
	for i := range values {
		if values[i] == nil {
