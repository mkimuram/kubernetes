...
func (b *PersistentVolumeClaimTemplateApplyConfiguration) WithUsingReferences(values ...*v1.UsingReferenceApplyConfiguration) *PersistentVolumeClaimTemplateApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
	for i := range values {
		if values[i] == nil {
