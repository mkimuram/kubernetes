...
func (b *ValidatingWebhookConfigurationApplyConfiguration) WithUsingReferences(values ...*v1.UsingReferenceApplyConfiguration) *ValidatingWebhookConfigurationApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
	for i := range values {
		if values[i] == nil {
