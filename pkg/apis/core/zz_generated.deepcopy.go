...
func (in *PersistentVolumeClaimSpec) DeepCopyInto(out *PersistentVolumeClaimSpec) {
	*out = *in
	...
	if in.Transfer != nil {
		...
		*out = new(PersistentVolumeClaimTransfer)
		(*in).DeepCopyInto(*out)
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PersistentVolumeClaimTransfer) DeepCopyInto(out *PersistentVolumeClaimTransfer) {
	*out = *in
	if in.Source != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PersistentVolumeClaimTransfer.
func (in *PersistentVolumeClaimTransfer) DeepCopy() *PersistentVolumeClaimTransfer {
	if in == nil {
		return nil
	}
	out := new(PersistentVolumeClaimTransfer)
